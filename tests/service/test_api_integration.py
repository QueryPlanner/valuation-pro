...
def _build_mock_ticker():
    ...
    q_inc = pd.DataFrame(
        {
            pd.Timestamp("2023-12-31"): {
                "Total Revenue": 13000.0,
                "Operating Income": 2000.0,
                "Research And Development": 800.0,
                "Pretax Income": 1900.0,
                "Tax Provision": 475.0,
            },
            ...
            pd.Timestamp("2023-03-31"): {
                ...
                "Operating Income": 2000.0,
                "Research And Development": 700.0,
                "Pretax Income": 1800.0,
                "Tax Provision": 450.0,
            },
        }
...
def test_api_full_flow_integration():
    ...
    """
    with (
        patch("valuation_service.connectors.yahoo.yf.Ticker") as mock_ticker_cls,
